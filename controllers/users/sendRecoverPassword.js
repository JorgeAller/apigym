...
const sendRecoverPassword = async (req, res, next) => {
    try {
        ...
        const emailContent = `
            Se ha solicitado la recuperación de contraseña para este email en Diario de Viajes. Utiliza el siguiente código para crear una nueva contraseña: ${recoverPassCode}
